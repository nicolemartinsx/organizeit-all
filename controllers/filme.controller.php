    ...
    public function index($id)
    {
        ...
        function PesquisarWatchlist($id, $idUsuario)
        {
            ...
            if (isset($_SESSION['id'])) {
                ...
                if ($query->rowCount() == 0) {
                    echo '<a class="btwatchlist" href="' . urldecode($id) . '/adicionar">adicionar a minha lista</a>';
                } else {
                    echo '<a class="btwatchlist" href="' . urldecode($id) . '/remover">remover da minha lista</a>';
                }
            }
        }
