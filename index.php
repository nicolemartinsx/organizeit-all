...
<body>
        ...
        <div class="header-container">
            ...
            <div class="alinhamentoheader">
                ...
                <div class="pesquisa">
                    ...
                    <a><img src="imagens/pesquisar.png" alt="Lupa" width="25"></a>
                </div>
    ...
    <main>
        ...
        <div class="filmes">
            <img src="imagens/1.jpg" class="capa" alt="Filme 1">
            <img src="imagens/2.jpg" class="capa" alt="Filme 2">
            <img src="imagens/3.jpg" class="capa" alt="Filme 3">
            <img src="imagens/4.jpg" class="capa" alt="Filme 4">
            <img src="imagens/5.jpg" class="capa" alt="Filme 5">
            <img src="imagens/6.jpg" class="capa" alt="Filme 6">
        </div>
        ...
        <div class="tabelareviews">
            <div class="review">
                ...
                <div class="info">
                    ...
                    <div class="estrela">
                        ...
                        <img src="imagens/estrela.png" />
                        <img src="imagens/estrela.png" />
                        <img src="imagens/estrela_outline.png">
                    </div>
            ...
            <div class="review">
                ...
                <div class="info">
                    ...
                    <div class="texto">
                        <img src="imagens/quote.png" class="icone" />
                        texto texto texto texto texto texto texto texto texto texto texto texto texto texto texto
                    </div>
                </div>
            </div>
